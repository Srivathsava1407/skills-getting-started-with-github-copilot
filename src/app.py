...
activities = {
    ...
    "Basketball Practice": {
        "description": "Work on basketball skills, drills, and game strategy",
        "schedule": "Tuesdays and Fridays, 4:30 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and creative visual art projects",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "lucas@mergington.edu"]
    },
    "Drama Club": {
        "description": "Develop acting, stagecraft, and performance skills",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["amelia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice persuasive speaking, reasoning, and public debate",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["isabella@mergington.edu", "mason@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments and scientific topics with weekly labs",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
